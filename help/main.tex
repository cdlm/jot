...
\usepackage{lipsum} % only needed for this example file
...
%---------------------------------------------------------------------
\howtocite{\url{http://www.jot.fm/general/JOT_template_LaTeX.tgz}}
%---------------------------------------------------------------------
...
\paragraph{Example} \url{http://www.jot.fm}, \email{damien.pollet@inria.fr}
